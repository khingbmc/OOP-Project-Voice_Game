...
import com.vaja.game.battle.animation.BattleSprite;

/**
 * @author khingbmc
 * render the battle scene and animation in battle
 */
...
public class BattleRenderer {
    ...
    public void render(SpriteBatch batch, BattleAnimation animation, BATTLE_PARTY primarilyAnimated) {
        ...
        float platformYOrigin = playerSquareMiddleY - platform.getRegionHeight() / 2 * Setting.SCALE;
        ...
        if (playerPokemon != null) {
            playerX = playerSquareMiddleX - playerPokemon.getWidth() / 2 * Setting.SCALE;
        ...
        if (opponentPokemon != null) {
            opponentX = opponentSquareMiddleX - opponentPokemon.getWidth() / 2 * Setting.SCALE;
        ...
        if (animation != null) {
            if (primarilyAnimated == BATTLE_PARTY.PLAYER) {
                ...
                playerX = playerSquareMiddleX - playerPokemon.getWidth() / 2 * Setting.SCALE * playerWidth;
                playerY = platformYOrigin + playerPokemon.getHeight() / 2 * Setting.SCALE - playerPokemon.getHeight() / 2 * Setting.SCALE * playerHeight;
                ...
                opponentX = opponentSquareMiddleX - opponentPokemon.getWidth() / 2 * Setting.SCALE * opponentWidth;
                opponentY = platformYOrigin + opponentPokemon.getHeight() / 2 * Setting.SCALE - opponentPokemon.getHeight() / 2 * Setting.SCALE * opponentHeight;
        ...
        /* render platforms */
        batch.draw(platform,
                playerSquareMiddleX - platform.getRegionWidth() / 2 * Setting.SCALE,
                platformYOrigin,
                platform.getRegionWidth() * Setting.SCALE,
                platform.getRegionHeight() * Setting.SCALE);
        batch.draw(platform,
                opponentSquareMiddleX - platform.getRegionWidth() / 2 * Setting.SCALE,
                platformYOrigin,
                platform.getRegionWidth() * Setting.SCALE,
                platform.getRegionHeight() * Setting.SCALE);
        ...
        if (playerPokemon != null) {
            ...
            if (animation != null && animation.getPrimaryMask() != null && !animation.isFinished()) {
                this.renderWithMask(
                        ...
                        playerX,
                        playerY,
                        playerWidth * playerPokemon.getWidth() * Setting.SCALE,
                        playerHeight * playerPokemon.getHeight() * Setting.SCALE,
                        true);
            } else {
                batch.draw(
                        playerPokemon,
        ...
        if (opponentPokemon != null) {
            ...
            batch.draw(
                    ...
                    opponentX,
                    opponentY,
                    opponentWidth * opponentPokemon.getWidth() * Setting.SCALE,
                    opponentHeight * opponentPokemon.getHeight() * Setting.SCALE,
                    0,
                    0,
        ...
        if (animation != null && !animation.isFinished()) {
            for (BattleSprite sprite : animation.getSprites()) {
                ...
                batch.draw(
                        sprite.getRegion(),
                        spriteX - sprite.getRegion().getRegionWidth() * sprite.getWidth() * Setting.SCALE / 2,
                        spriteY - sprite.getRegion().getRegionHeight() * sprite.getHeight() * Setting.SCALE / 2,
                        (sprite.getRegion().getRegionWidth() * sprite.getWidth() * Setting.SCALE) / 2,
                        (sprite.getRegion().getRegionHeight() * sprite.getHeight() * Setting.SCALE) / 2,
                        Setting.SCALE * sprite.getWidth() * sprite.getRegion().getRegionWidth(),
                        Setting.SCALE * sprite.getHeight() * sprite.getRegion().getRegionHeight(),
                        1f,
                        1f,
                        sprite.getRotation());
                batch.setColor(1f, 1f, 1f, 1f);
