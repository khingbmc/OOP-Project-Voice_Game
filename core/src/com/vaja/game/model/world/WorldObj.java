...
public class WorldObj implements YSortable{
    ...
    public WorldObj(int x, int y, boolean walkable, TextureRegion texture, float sizeX, float sizeY, GridPoint2 tile) {
        this.x = x;
        this.y = y;
        this.texture = texture;
        this.sizeX = sizeX;
    ...
    public WorldObj(int x, int y, boolean walkable, TextureRegion texture, float sizeX, float sizeY, GridPoint2[] tiles) {
        this.x = x;
        this.y = y;
        this.texture = texture;
        this.sizeX = sizeX;
    ...
    public WorldObj(int x, int y, boolean walkable, Animation animation, float sizeX, float sizeY, GridPoint2[] tiles) {
        this.x = x;
        this.y = y;
